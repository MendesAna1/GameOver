...
["ordenador", "Una máquina"],
 ["laurel", "Un árbol"],
  ["plaza", "Espacio público"],
   ["internet", "Gran invento"],
    ["manzana", "Una fruta"],
     ["monopoly", "Un juego"],
      ["higuera", "Un árbol"],
       ["everest", "Un monte"],
        ["relampago", "Antecede al trueno"],
         ["murcielago", "Un animal"],
          ["luxemburgo", "Un país"],
           ["uruguay", "Un país"],
            ["ilustracion", "Representación gráfica"],
             ["excursion", "Actividad en la naturaleza"],
              ["medialunas", "De la panadería"],
               ["teclado", "Componente de computadora"],
...
function compruebaFin() {
  if( oculta.indexOf("_") == -1 ) {
    document.getElementById("msg-final").innerHTML = "WINNER";
